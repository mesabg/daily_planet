...
function load_more_nopub(){
    ...
    .done(function(data) {
        ...
        for(var i=0; i<data.length;i++){
            var tr = $('<tr><td class="Nombre">'+data[i].nombre+'</td> <td class="Fecha">'+data[i].fecha+'</td> <td><center>'+data[i].editando+'</center></td> <td><a href="/modificar_articulo?id='+data[i]._id+'" class="btn btn-warning col-md-6">Modificar</a><button class="btn btn-success col-md-6" onclick="publicar(this.parentNode.parentNode)">Publicar</button></td></tr>')
